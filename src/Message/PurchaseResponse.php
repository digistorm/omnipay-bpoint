...
{
    public const API_CODE_MESSAGES = [
        '?' => 'Response Unknown',
    ...
    public const BANK_CODE_MESSAGES = [
        '00' => 'Approved',
        '08' => 'Honour with ID',
    ...
    public function isSuccessful(): bool
    {
        ...
        return $responseCode == '0' || $responseCode == '00' || $responseCode == '08' || $responseCode == '16';
    }
        ...
        if (!$this->isSuccessful()) {
            ...
            if (isset($this->data['TxnResp']['ResponseCode'], $this->data['TxnResp']['ResponseText'])) {
                ...
                if ($responseCode == '1' || $responseCode == '2' || $responseCode == '3' || $responseCode == '4' || $responseCode == '5') {
                    ...
                    $fullErrorMessage = self::BANK_CODE_MESSAGES[$bankResponseCode] ?? null;
                } else {
                    $fullErrorMessage = self::API_CODE_MESSAGES[$responseCode] ?? 'Response Unknown';
                }
    ...
    public function getCode(): ?string
    {
        ...
        if (!$this->isSuccessful()) {
            ...
            if (isset($this->data['TxnResp']['ResponseCode'], $this->data['TxnResp']['ResponseText'])) {
                ...
                // Transaction response codes 1-5 will use the bank response code and message
                if ($responseCode == '1' || $responseCode == '2' || $responseCode == '3' || $responseCode == '4' || $responseCode == '5') {
                    return $this->data['TxnResp']['BankResponseCode'];
                }
    ...
    {
        return $this->data['TxnResp']['TxnNumber'] ?? null;
    }
